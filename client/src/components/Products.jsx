    ...
    <section className="section section-alt" id="products">
      <div className="container">
        <div className="section-header fade-up">
          ...
          <h2 className="section-title dark">三大专属金融产品</h2>
          ...
          {products.map(p => (
            <div key={p.code} className="product-card">
              ...
              <div className="product-body">
                ...
                <a className="product-cta" href="#guide" onClick={e => { e.preventDefault(); document.getElementById('guide')?.scrollIntoView({behavior:'smooth'}) }}>
        ...
        <div className="compare-wrap fade-up">
          <div className="section-header" style={{marginTop:60, marginBottom:30}}>
            ...
            <h2 className="section-title dark">北京Token贷产品对比表</h2>
          </div>
          <table className="compare-table">
            <thead>
              <tr><th>对比维度</th><th>Token贷</th><th>算力贷</th><th>OPC贷</th></tr>
            </thead>
            <tbody>
              <tr><td><strong>额度核定</strong></td><td>按Kai TPM期货交易数据核定</td><td>按算力租赁费用30%</td><td className="compare-highlight">综合TPM消耗+征信+知识产权</td></tr>
              <tr><td><strong>最高额度</strong></td><td>按TPM·h消耗量动态核定</td><td className="compare-highlight">2000万元</td><td>500万元词元券支持</td></tr>
              <tr><td><strong>补贴比例</strong></td><td>按TPM合同/消耗额度</td><td>算力租赁费用30%</td><td className="compare-highlight">词元消耗费用50%</td></tr>
              <tr><td><strong>适用对象</strong></td><td>Kai平台企业采购方</td><td>Kai认证容量供应商</td><td className="compare-highlight">OPC（一人公司）创业者</td></tr>
              <tr><td><strong>增信方式</strong></td><td>Kai TPM结算数据</td><td>算力租赁合同+容量注册</td><td className="compare-highlight">TPM消耗+征信+知识产权+赛事获奖</td></tr>
              <tr><td><strong>数据来源</strong></td><td className="compare-highlight">Kai期货交易与结算记录</td><td>Kai容量注册与交付确认</td><td>Kai聚合商子账户分配数据</td></tr>
              <tr><td><strong>参考模式</strong></td><td>广州Token贷模式（北京版）</td><td>亦庄"词元十条"</td><td className="compare-highlight">北京OPC创新发展行动方案</td></tr>
            </tbody>
          </table>
        </div>
      </div>
