...
const mapData = [
  { name: '壹号词元工厂', color: '#2563eb', desc: '北京首座词元工厂，位于亦庄核心区。日产能突破1.4万亿词元，打造词元经济"超级入口"。作为Kai认证容量供应商，提供标准化模型服务能力。' },
  { name: '京算词元工厂', color: '#a78bfa', desc: '北京首家国资词元工厂，亦庄点亮运营。具备国资背景的词元生产基地，同样作为Kai认证容量供应商参与市场。' },
  { name: 'Kai 容量市场交易中心', color: '#a78bfa', desc: 'TPM期货交易核心枢纽。提供统一API、交易组织、容量路由、计量和结算管理。连接模型发布商、容量供应商、企业买家和聚合商。' },
  { name: '模数OPC社区', color: '#06b6d4', desc: '超4万平米OPC社区，服务超500家OPC（一人公司）主体。Kai聚合商入驻，为中小OPC创业者批量采购TPM容量并以子账户分配。' },
  { name: '"即用即补"模型券兑现平台', color: '#06b6d4', desc: '词元经济超级入口，对接Kai交付确认数据。企业可在此申请算力券（30%补贴最高2000万）和词元券（50%支持最高500万）。' },
  { name: '北京智算集群', color: '#a78bfa', desc: '算力基础设施核心节点，Kai容量注册来源。为词元工厂和模型服务提供底层算力支撑，行云科技在此获超百亿授信建设。' }
]

const markers = [
  { cx: 180, cy: 180, color: '#2563eb' },
  { cx: 380, cy: 160, color: '#a78bfa' },
  { cx: 290, cy: 250, color: '#a78bfa' },
  { cx: 430, cy: 310, color: '#06b6d4' },
  { cx: 150, cy: 330, color: '#06b6d4' },
  { cx: 470, cy: 380, color: '#a78bfa' },
]
    ...
    <section className="section section-alt" id="about">
      <div className="container">
        <div className="section-header fade-up">
          ...
          <h2 className="section-title dark">平台定位与合作生态</h2>
        ...
        <div className="about-grid fade-up">
          <div className="about-text">
            ...
            <div style={{marginTop:20, padding:16, background:'var(--bg-surface)', borderRadius:12, borderLeft:'3px solid var(--cyan)'}}>
              <p style={{fontSize:14, color:'var(--text-body)', lineHeight:1.6}}>
                <strong style={{color:'var(--cyan)'}}>技术合作方 · Kai</strong> —— 本平台由 Kai 企业模型服务容量市场提供TPM（每分钟令牌负载）数据支持，为Token贷额度核定提供客观、可验证的消耗数据基础。
              </p>
            </div>
          ...
          <div>
            <div className="map-card">
              ...
              <div className="map-legend">
                <div className="map-legend-item"><div className="map-legend-dot" style={{background:'#2563eb'}}></div> 词元工厂</div>
                <div className="map-legend-item"><div className="map-legend-dot" style={{background:'#a78bfa'}}></div> 交易/结算中心</div>
                <div className="map-legend-item"><div className="map-legend-dot" style={{background:'#06b6d4'}}></div> OPC/兑现平台</div>
              </div>
                ...
                <svg className="map-svg" viewBox="0 0 600 500" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="mapBgGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" style={{stopColor:'#0a1530'}} />
                      <stop offset="50%" style={{stopColor:'#0f2140'}} />
                      <stop offset="100%" style={{stopColor:'#1a1050'}} />
                    </linearGradient>
                  ...
                  <path d="M 80 120 Q 150 80 220 100 L 300 70 Q 380 85 460 110 L 530 90 L 560 140 L 540 200 L 560 280 L 520 360 L 460 400 L 380 420 L 280 440 L 180 420 L 100 380 L 60 300 L 50 200 L 80 120 Z" fill="rgba(37,99,235,0.06)" stroke="rgba(37,99,235,0.2)" strokeWidth="1" strokeDasharray="4 3"/>
                  <path d="M 150 200 Q 200 180 260 190 L 340 175 Q 400 190 440 210 L 470 260 L 430 310 L 360 320 L 270 310 L 190 280 L 150 200 Z" fill="rgba(124,58,237,0.05)" stroke="rgba(124,58,237,0.15)" strokeWidth="1"/>
